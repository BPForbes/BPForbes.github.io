...
\textbf{P4 (allowed runtime deps):} React, TypeScript, browser APIs, Vitest for CI. Existing optional outbound \texttt{fetch} to user-local Ollama (\texttt{llm/config.ts}) remains client-initiated only; it is not required for parity.
\end{quote}
